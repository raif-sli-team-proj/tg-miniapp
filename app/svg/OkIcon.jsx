...
export default function OkIcon({width, height}) {
    return (
    <svg width={width} height={height} viewBox="0 -3 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">        
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g transform="translate(-518.000000, -1039.000000)" fill="#5ed1b6">
